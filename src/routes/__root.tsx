...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Análisis académico del phishing como delito informático en Venezuela: marco legal LECDI, impacto psicológico, casos reales y prevención. Blog de Informática elaborado por Camila Alva, Escuela de Derecho de la Universidad Bicentenaria de Aragua (UBA), Maracay 2026." },
      { name: "author", content: "Camila Alva — Escuela de Derecho de la UBA" },
